...
const PrintProjectView = () => {
  ...
  return (
    <div className=" mx-auto mt-[10rem] p-6 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      {step === 3 && (
        <div className="space-y-6 fade-in">
          <div className="bg-blue-50 p-6 rounded-xl text-center border border-blue-100">
            <h3 className="text-gray-600 font-medium mb-2">Quick Estimation</h3>
          ...
          <p className="text-gray-700 text-center">
            Do you wish to continue and send these details to our shop manager?
          </p>
