...
const PRODUCTS = [
  {
    ...
    price: 38.0,
    tag: "",
    desc: "A commanding retail size designed to fit perfectly into mall stanchions and theater lobby frames for high visibility.",
  ...
  },
  {
    ...
    price: 45.19,
    tag: "Best Seller",
    desc: "A sprawling wide-format print that acts as a centerpiece for corporate lobbies or spacious residential living rooms.",
  ...
  },
  {
    ...
    price: 62.14,
    tag: "Popular",
    desc: "An elongated panoramic format that captures wide landscapes or serves as a striking vertical gallery piece.",
...

  {
    ...
    price: 110.0,
    tag: "Best Value",
    desc: "The gold standard for business announcements, designed for maximum legibility across storefronts and grand openings.",
  ...
  },
  {
    ...
    price: 195.0,
    tag: "Heavy Duty",
    desc: "Massive outdoor advertising space ideal for construction site fences, stadium walls, and high-impact roadside marketing.",
    comparison: "Full sheet of plywood",
    rating: 4.9,
    reviews: 89,
    sizes: ['8" x 10"', '11" x 14"', '16" x 20"'],
    papers: ["Vinyl", "Chrome", "Banner", "Window Perf"],
...

  {
    ...
    price: 281.37,
    tag: "Heavy Duty",
    desc: "A premier 20-foot banner offering stadium-tier visibility, perfect for long-range viewing and massive event backdrops.",
  ...
  },
  {
    ...
    price: 337.87,
    tag: "Heavy Duty",
    desc: "High-performance vinyl spanning 25 feet, designed for elite commercial applications and large-scale industrial branding.",
  ...
  },
  {
    ...
    price: 394.37,
    tag: "Heavy Duty",
    desc: "Our largest standard banner, providing 120 square feet of advertising space for maximum possible visual dominance.",
    comparison: "The length of a school bus",
    rating: 4.9,
    reviews: 89,
    sizes: ['8" x 10"', '11" x 14"', '16" x 20"'],
    papers: ["Vinyl", "Chrome", "Banner", "Window Perf"],
  ...
  },
  {
    ...
    price: 185.0,
    tag: "Business Pro",
    desc: "Turn your vehicle into a moving ad with 50/50 perforated film that stays transparent for the driver but vibrant for the public.",
    comparison: "Covers standard rear windshield",
    rating: 4.8,
    reviews: 65,
  ...
  },
  {
    ...
    price: 2450.0,
    tag: "Premium",
    desc: "A complete aesthetic and functional transformation, protecting your paint while turning the entire vehicle into a premium billboard.",
    comparison: "Total vehicle transformation",
    rating: 5.0,
    reviews: 42,
    sizes: ["Sedan/Coupe", "SUV/Truck", "Van/Fleet"],
