...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 2450.0,
    tag: "Premium",
    desc: "Complete mobile billboard. High-performance vinyl covering all painted surfaces with a seamless finish.",
  ...
  },
  {
    ...
    price: 185.0,
    tag: "Business Pro",
    desc: "High-visibility advertising from the outside, perfectly clear vision from the inside. Legal and safe for driving.",
